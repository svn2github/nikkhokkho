...
#define KS_EXTENSION_ZIP	_T(" .air .apk .appx .cbz .docm .docx .dotx .dotm .dwf .dwfx .easm .epub .itz .ipa .jar .ksf .mdz .miz .mmip .mpp .msz .nar .odb .odf .odg .odp .ods .odt .oex .osk .oxps .ppam .potm .potx .ppsm .ppsx .pptm .pptx .pub .rmskin .s3z .sldm .sldx .vdx .vtx .vsx .wal .wmz .wsz .xap .xlam .xlsm .xlsx .xltm .xltx .xmz .xpi .xps .zip ")

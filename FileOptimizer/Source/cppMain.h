...
#define KS_EXTENSION_OLE	_T(" .art .chm .chi .chq .chs .chw .doc .dot .fla .fpx .its .lit .max .mce .mdb .mdt .mic .mix .mpd .mpp .mpt .msi .msg .msp .mst .one .ost .pps .ppt .pub .puz .rfa .rft .rte .rvt .sldasm .sldprt .slddrw stickynotes.snt thumbs.db .vsd .vst .vss .wiz .xl .xlc .xlm .xls .xlw .xsf .xsn ")

...
#define KS_EXTENSION_ZIP	_T(" .air .apk .appx .bar .bsz .cbz .cdr .cdt .csl .des .docm .docx .dotx .dotm .dwf .dwfx .easm .epub .fxg .grs .kmz .ipsw .itz .ipa .ita .jar .ksf .kmz .mdz .miz .mmip .mvz .mpp .msz .nar .odb .odf .odg .odp .ods .odt .oex .osk .oxps .pk3 .ppam .potm .potx .ppsm .ppsx .pptm .pptx .pub .r2skin .rdb .rmskin .s3z .sldm .sldx .stz .swc .vdx .vtx .vsx .wal .wba .wmz .wsz .xap .xlam .xlsm .xlsx .xltm .xltx .xmz .xpi .xps .zip ")

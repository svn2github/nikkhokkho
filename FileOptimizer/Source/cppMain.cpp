...
void __fastcall TfrmMain::FormDestroy(TObject *Sender)
{
	...
	clsUtil::SetIni(_T("Options"), _T("DisablePluginMask"), gudtOptions.acDisablePluginMask, _T("String. Default: ''. Allow excluding execution of certain plugins. For instance leanify;advpng.exe will prevent executing any plugin containing in its name leanify or advpng.exe. It is case insensitive, and allows more than one item to be specified by using semicolon (;) as separator."));

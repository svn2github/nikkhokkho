...
"\Archivos de programa\7-Zip\7z" a -mx=9 -mfb=273 -mmt=off -myx9 FileOptimizerSource.7z *.cbproj *.bat *.txt *.chm *.mes *.res *.ico *.cpp *.h Source\*.* Source\gifsicle\*.* Source\jpegoptim\*.* Source\libjpeg\*.* Source\jpegoptim\win32\*.* Source\gifsicle\src\*.* Source\gifsicle\include\*.* Source\gifsicle\include\lcdf\*.* Source\gifsicle\include\lcdfgif\*.* Source\jsmin\*.* Resource\*.* Resource\Icon\*.* Help\*.* Help\Images\*.* Setup\*.*
cd Win32\Release
